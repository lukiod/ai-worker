...
from runner.pipelines.utils import get_model_dir, get_torch_device
from runner.pipelines.utils.audio import AudioConverter
...
class AudioToTextPipeline(Pipeline):
    ...
    @property
    def router(self):
        from runner.routes import audio_to_text
