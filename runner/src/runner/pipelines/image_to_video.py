...
from runner.pipelines.utils import SafetyChecker, get_model_dir, get_torch_device
from runner.utils.errors import InferenceError
...
class ImageToVideoPipeline(Pipeline):
    ...
    def __init__(self, model_id: str):
        ...
        if sfast_enabled:
            ...
            from runner.pipelines.optim.sfast import compile_model
        ...
        if deepcache_enabled:
            ...
            from runner.pipelines.optim.deepcache import enable_deepcache
    ...
    @property
    def router(self):
        from runner.routes import image_to_video
